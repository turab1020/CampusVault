    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-6 w-full">
            ...
            <BrutalCard className="bg-white border-4 mb-12 p-8">
                <h2 className="font-heading text-3xl uppercase mb-4 text-black tracking-tighter">
                    The Mission
                </h2>
                <p className="font-sans text-xl font-bold text-gray-700 leading-relaxed mb-6">
                ...
                <p className="font-sans text-lg text-gray-700 font-bold leading-relaxed mb-6">
                ...
                <p className="font-sans text-lg text-gray-700 font-bold leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <BrutalCard className="bg-secondary border-4 p-8">
                    <h3 className="font-heading text-2xl uppercase mb-4 text-black font-black tracking-tighter">Open Source</h3>
                ...
                <BrutalCard className="bg-primary text-white border-4 p-8">
                    <h3 className="font-heading text-2xl uppercase mb-4 font-black tracking-tighter text-black mix-blend-multiply">Trust First</h3>
